sap.ui.define(
	...
	return BaseController.extend("CriptAnaliser.src.pages.exemplos.CustomControls", {
		...
		onSerchDimession : function(oEvent){
            ...
            if (!this._oDialogDimensions) {
                this._oDialogDimensions = sap.ui.xmlfragment("CriptAnaliser.view.fragments.ChooseFromModal", this);
